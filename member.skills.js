...
async function scanMemberSkills(userId, esMemberSkillsIndices, esMemberSkillsMappings) {
    ...
    try {
        const membersAggregatedSkills = await dynamo.query(memberAggregatedSkillsParams).promise();
        if (membersAggregatedSkills != null) {
            for (let masIndex = 0; masIndex < membersAggregatedSkills.Items.length; masIndex++) {
                ...
                if (membersEnteredSkills != null && membersEnteredSkills.Items.length > 0) {
                    ...
                    membersAggregatedSkills.Items[masIndex].createdBy = (membersEnteredSkills.Items[0].userId).toString()
                    membersAggregatedSkills.Items[masIndex].updatedBy = (membersEnteredSkills.Items[0].userId).toString()
                    membersAggregatedSkills.Items[masIndex].updatedAt = moment().valueOf()
                    delete membersAggregatedSkills.Items[masIndex].updatedAt
                    delete membersAggregatedSkills.Items[masIndex].updatedBy
                } else {
                    ...
                    if (memberProfile != null && memberProfile.Items.length > 0) {
                        ...
                        membersAggregatedSkills.Items[masIndex].createdBy = (memberProfile.Items[0].userId).toString()
                        membersAggregatedSkills.Items[masIndex].handleLower = memberProfile.Items[0].handleLower
                        membersAggregatedSkills.Items[masIndex].updatedBy = (memberProfile.Items[0].userId).toString()
                        membersAggregatedSkills.Items[masIndex].updatedAt = moment().valueOf()
                    }
                }
...
/*
    ...
    node member.skills.js dev 23006458
